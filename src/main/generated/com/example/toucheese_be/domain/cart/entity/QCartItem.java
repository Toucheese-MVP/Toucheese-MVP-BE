...
public class QCartItem extends EntityPathBase<CartItem> {
    ...
    private static final long serialVersionUID = 1597461806L;
    ...
    public final ListPath<CartItemOption, QCartItemOption> cartItemOptions = this.<CartItemOption, QCartItemOption>createList("cartItemOptions", CartItemOption.class, QCartItemOption.class, PathInits.DIRECT2);
