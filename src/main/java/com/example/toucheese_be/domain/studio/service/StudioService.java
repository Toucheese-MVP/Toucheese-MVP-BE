...
public class StudioService {
     ...
     */
    public Page<StudioDto> getStudiosByConceptFilters(Long conceptId, StudioSearchFilterDto filters, Pageable pageable) {
        return studioRepository.getStudioListWithPages(conceptId, filters, pageable);
    }
}
